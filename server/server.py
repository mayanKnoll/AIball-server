...
HOST = "34.125.245.207"  # Standard loopback interface address (localhost)
...
#         serverSocket.setsockopt(0,   # level is 0 (IPPROTO_IP)
...
#                 done = False
#             massage, ctl, flags ,address = serverSocket.recvmsg(1500, 1024)
#             print(massage)
#             # T_next_game.join()
...
#                 data.append(massage)
#             data = '[' + ",".join(data) + "]"
#             serverSocket.sendmsg(data.encode(), ctl, 0,address)
...
#     import os
#     import client
#     th  = threading.Thread(target=client.main, args=())
#     th.start()
#     server('34.125.245.207',port=int(os.environ.get("PORT", 3000)))
